        ...
        panels: [
          {
            ...
            alt: 'Social Lama on Instagram — the post grid',
            width: 801,
            height: 915,
          },
          {
            src: '/assets/services-tiktok.png',
            alt: 'Social Lama on TikTok — 55.4k likes',
            width: 1149,
            height: 944,
          },
          {
            src: '/assets/services-linkedin.png',
            alt: 'Social Lama page on LinkedIn',
            width: 827,
            height: 918,
          },
          {
            src: '/assets/services-x.png',
            alt: 'Social Lama on X',
            width: 887,
            height: 847,
          },
          {
            src: '/assets/services-pinterest.png',
            alt: 'Social Lama on Pinterest',
            width: 900,
            height: 1117,
          },
          {
            src: '/assets/services-youtube.png',
            alt: 'Social Lama channel on YouTube',
            width: 900,
            height: 1117,
          },
        ],
      ...
      stage: {
        ...
        panels: [
          ...
          },
          {
            ...
            alt: 'Instagram insights — growth in reach and followers',
            width: 900,
            height: 1117,
          },
          {
            src: '/assets/services-ytstudio.png',
            alt: 'YouTube channel stats — growth in views',
            width: 1100,
            height: 821,
          },
          {
            src: '/assets/services-xanalytics.png',
            alt: 'X analytics — growth in views and engagement',
            width: 1100,
            height: 821,
          },
          {
            src: '/assets/services-tiktokstudio.png',
            alt: 'TikTok Studio — views and followers stats',
            width: 1100,
            height: 821,
          },
          {
