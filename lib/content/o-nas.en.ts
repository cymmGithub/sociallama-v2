...
export const oNasTeam = {
  ...
  members: [
    ...
    },
    {
      ...
      bio: "Art & Creative Director at Diea, a creative agency specializing in branding, graphic design, video production, and animation. He pairs an aesthetic eye with strategic thinking — from visual identities, through campaign key visuals, to digital assets. He makes sure the creative work doesn't just look good, but genuinely works toward the brand's goals.",
