...
export const oNasTeam = {
  ...
  members: [
    ...
    },
    {
      ...
      bio: "She specializes in communication for B2B and medical brands. She pairs a strategic approach with a management background, which keeps social media work tied tightly to clients' business goals. She owns planning and coordination, and turns business strategy into measurable results. She also produces the visuals — graphics, video, and UGC — in line with industry regulations.",
    ...
    },
    {
      ...
      surname: 'BOROWIK',
      role: 'Senior Social Media Specialist',
      bio: 'She pairs a strategic eye with communication instinct, helping brands find their own coherent direction. For over 10 years she has worked in marketing and digital, treating communication as a whole — from strategy, through engaging content, to reading the results. Relationships matter to her: work built on openness and understanding is effective and lasts. She especially values her work for HoReCa, travel, and parenting.',
