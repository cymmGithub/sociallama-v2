...
const PLAN: Op[] = [
  ...
  },
  {
    kind: 'detach',
    slug: 'belvedere',
    file: 'belvedere-gallery-1.jpg',
    why: "Client photo — P 2026-08-18: only the collagen reel may be used ('tylko to foto')",
  },
  {
    kind: 'detach',
    slug: 'belvedere',
  ...
  },
  {
    ...
    why: 'Bottom-cropped to drop the video player bar; the person stays (P 2026-08-18 correction)',
    to: { file: 'riviera-gallery-3-crop.jpg', copyAlt: true },
  },
  {
    kind: 'detach',
    slug: 'riviera',
  ...
  // —— polomarket ———————————————————————————————————————————————————————————
  {
    ...
    why: 'Moderation screenshots removed entirely (P 2026-08-18, superseding the anonymization)',
  },
  {
    kind: 'detach',
    slug: 'polomarket',
  ...
  // —— mockup cutouts (P 2026-08-18) ———————————————————————————————————————
  //
  // Phone mockups were exported on their own plate — a black or white slab that
  // the frameless treatment (task 1) leaves sitting on the sand page as a hard
  // rectangle. Each of these carries the same creative with the plate trimmed
  // and the device corners keyed to transparency, so the phone floats.
  //
  // `copyAlt` throughout: the picture is unchanged, only its canvas is.
  // The gate that picked these is deliberately narrow — a flat creative whose
  // margin is part of the design must never be trimmed, and four plain
  // photographs that passed the corner test by luck are excluded by name.

  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-3.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-5.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-6.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'a1-karting',
    file: 'a1-karting-gallery-7.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'a1-karting-gallery-7-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-2.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-5.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'adamed',
    file: 'adamed-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'adamed-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ariadna',
    file: 'ariadna-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'ariadna-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ariadna',
    file: 'ariadna-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ariadna-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ariadna',
    file: 'ariadna-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ariadna-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ariadna',
    ...
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ariadna-gallery-9-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'asus',
    file: 'asus-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'asus-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'asus',
    file: 'asus-gallery-5.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'asus-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'asus',
    file: 'asus-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'asus-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'belvedere',
    file: 'belvedere-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'belvedere-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dolina-charlotty',
    file: 'dolina-charlotty-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'dolina-charlotty-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dolina-charlotty',
    file: 'dolina-charlotty-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'dolina-charlotty-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dolina-charlotty',
    file: 'dolina-charlotty-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'dolina-charlotty-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dolina-charlotty',
    file: 'dolina-charlotty-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'dolina-charlotty-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dolina-charlotty',
    file: 'dolina-charlotty-gallery-5.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'dolina-charlotty-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dynamic-development',
    file: 'dynamic-development-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'dynamic-development-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dynamic-development',
    file: 'dynamic-development-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'dynamic-development-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dynamic-development',
    file: 'dynamic-development-gallery-5.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'dynamic-development-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'dynamic-development',
    file: 'dynamic-development-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'dynamic-development-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ed-invest',
    file: 'ed-invest-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ed-invest-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ed-invest',
    file: 'ed-invest-gallery-2.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ed-invest-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ed-invest',
    file: 'ed-invest-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ed-invest-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'ed-invest',
    file: 'ed-invest-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'ed-invest-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'engie',
    file: 'engie-gallery-1-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'engie-gallery-1-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'engie',
    file: 'engie-gallery-2-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'engie-gallery-2-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'engie',
    file: 'engie-gallery-3-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'engie-gallery-3-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'engie',
    file: 'engie-gallery-5-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'engie-gallery-5-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'engie',
    file: 'engie-gallery-6-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'engie-gallery-6-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-2.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-5.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-6.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-7.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-7-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-8.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-8-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'entelo',
    file: 'entelo-gallery-9.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'entelo-gallery-9-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'fm-logistics',
    file: 'fm-logistics-greensupply-1.png',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'fm-logistics-greensupply-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'getaway',
    file: 'getaway-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'getaway-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'getaway',
    file: 'getaway-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'getaway-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'getaway',
    file: 'getaway-gallery-3.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'getaway-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'irobot',
    file: 'irobot-gallery-3-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'irobot-gallery-3-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'irobot',
    file: 'irobot-gallery-6-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'irobot-gallery-6-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'irobot',
    file: 'irobot-edukacja-2.png',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'irobot-edukacja-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'julius-meinl',
    file: 'julius-meinl-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'julius-meinl-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'las-vegans',
    file: 'las-vegans-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'las-vegans-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'laurastar',
    file: 'laurastar-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'laurastar-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'laurastar',
    file: 'laurastar-gallery-3.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'laurastar-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'laurastar',
    file: 'laurastar-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'laurastar-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'mercator',
    file: 'mercator-gallery-3.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'mercator-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'mercator',
    file: 'mercator-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'mercator-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'mercator',
    file: 'mercator-gallery-5.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'mercator-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'mercator',
    file: 'mercator-gallery-6.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'mercator-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'mercator',
    file: 'mercator-gallery-7.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'mercator-gallery-7-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'motointegrator',
    file: 'motointegrator-gallery-1.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'motointegrator-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-5.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-6.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-9.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-9-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'personal-effect',
    file: 'personal-effect-gallery-10.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'personal-effect-gallery-10-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-5.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-5-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-6.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-7.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-7-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-8.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-8-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'power-elements',
    file: 'power-elements-gallery-9.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'power-elements-gallery-9-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'riviera',
    ...
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'riviera-gallery-6-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skibooking',
    file: 'skibooking-gallery-1.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skibooking-gallery-1-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skibooking',
    file: 'skibooking-gallery-2.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skibooking-gallery-2-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skibooking',
    file: 'skibooking-gallery-3.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skibooking-gallery-3-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skrzat',
    file: 'skrzat-gallery-4.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skrzat-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skrzat',
    file: 'skrzat-gallery-7.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skrzat-gallery-7-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'skrzat',
    file: 'skrzat-gallery-8.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'skrzat-gallery-8-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'vobis',
    file: 'vobis-gallery-4.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'vobis-gallery-4-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'volvo',
    file: 'volvo-vcw-post-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'volvo-vcw-post-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'volvo',
    file: 'volvo-vcw-goracy-anon.jpg',
    why: 'Full-bleed phone mockup on a square canvas — corners rounded to the device radius',
    to: { file: 'volvo-vcw-goracy-anon-cut.webp', copyAlt: true },
  },
  {
    kind: 'swap',
    slug: 'volvo',
    file: 'volvo-dom-savedate-anon.jpg',
    why: 'Phone mockup exported on a uniform plate — plate trimmed, device corners keyed out',
    to: { file: 'volvo-dom-savedate-anon-cut.webp', copyAlt: true },
  },
]
