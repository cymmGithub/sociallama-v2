...
**Reason**: The tight 4:3 crop belonged to the retired TV shell; the bare composite uses the wide reference composition.
**Migration**: Superseded by "Wide right-anchored framing for bare compositing".

### Requirement: Motion arc with impressed ending
**Reason**: The theatrical impressed beat is replaced by the tail-trimmed subtle beat of the committed take.
**Migration**: Superseded by "Head-turn arc with tail-trimmed impressed ending".

### Requirement: Scrub-ready encoding
**Reason**: Encoding requirements now include the seamless-composite gate (the hero's exemption is revoked with the shell gone).
**Migration**: Superseded by "Scrub-ready encoding with seamless-composite gate".
