...
- **DOM grows on the LCP element.** Fifteen nodes per breakpoint instance (seven outgoing bands, seven incoming, one resting layer) where five `<img>` sit today — about 30 total across both breakpoints. Accepted deliberately; see `design.md`.
