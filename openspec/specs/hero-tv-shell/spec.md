...
Define the retro TV shell that frames the hero video: the generated shell asset, video alignment to the measured screen rect, screen overlays that neutralize background drift, and the hero clip's exemption from the seamless-composite gate.
