...
## Purpose
Define the homepage FAQ section: its placement in the closing chapter, its server-rendered disclosure behaviour, its `FAQPage` structured data, and its per-locale copy.
## Requirements
